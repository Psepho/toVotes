...
`toFederalVotes` contains the results of the 2006, 2008, and 2011 Federal elections for Electoral Districts in Toronto, taken from [Elections Canada](http://www.elections.ca/). The datframe contains:
